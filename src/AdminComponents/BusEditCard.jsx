...
import CitiesSelect from "../GlobalComponents/CitiesSelect";
...
const BusEditCard = ({ info, idx, setData, deleteItem }) => {
  ...
  const handleData = () => {
    ...
    if (newFormData?.active !== true) newFormData.active = false;
